 ...
 */
public class ThreadedACGLikelihoodTest extends TestBase {

    public ThreadedACGLikelihoodTest() { }
    ...
    public void testLikelihoodFixedData() throws Exception {
        ...
        ThreadedACGLikelihood threadedACGLikelihood = new ThreadedACGLikelihood();
        threadedACGLikelihood.initByName(
                "threads", 4,
                "locus", locus,
                "tree", acg,
                "siteModel", siteModel);
        ...
        double logPtrue = argLikelihood.calculateLogP();
        double logP = threadedACGLikelihood.calculateLogP();

        double relativeDiff = Math.abs(2.0*(logPtrue-logP)/(logPtrue+logP));

        assertTrue("1 failed",relativeDiff<1e-14);
        ...
        logPtrue = threadedACGLikelihood.calculateLogP();

        relativeDiff = Math.abs(2.0*(logPtrue-logP)/(logPtrue+logP));
        
        assertTrue("2 failed",relativeDiff<1e-14);
        ...
        assertTrue("3 failed",relativeDiff<1e-14);
    }
    ...
    public void testLikelihoodAmbiguities() throws Exception {
        ...
        logP = threadedACGLikelihood.calculateLogP();
        logPtrue = argLikelihood.calculateLogP();
    ...
    public void testLikelihoodUsingSimulatedData() throws Exception {
        ...
        double threadedLogP = threadedACGLikelihood.calculateLogP();

        double relError = 2.0*Math.abs(logP-threadedLogP)/Math.abs(logP + threadedLogP);
        System.out.format("logP=%g\nthreadedLogP=%g\nrelError=%g\n",
                logP, threadedLogP, relError);
    ...
    public void testLikelihoodCaching() throws Exception {
        ...
        ACGLikelihoodSlow threadedACGLikelihood = new ACGLikelihoodSlow();
        threadedACGLikelihood.initByName(
                "locus", locus,
                "data", alignment,
                "tree", acg,
        ...
        double logP1prime = threadedACGLikelihood.calculateLogP();
        ...
        double logP2prime = threadedACGLikelihood.calculateLogP();
        ...
        double logP3prime = threadedACGLikelihood.calculateLogP();
